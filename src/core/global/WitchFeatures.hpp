...
#	define WITCHENGINE_NO_VERTEX_SHADER
#endif
...
#	define WITCHENGINE_NO_FRAGMENT_SHADER
#endif
...
#	define WITCHENGINE_NO_GEOMETRY_SHADER
#endif
...
#	define WITCHENGINE_NO_COMPUTE_SHADER
#endif
...
// Ray-tracing shader
#if !defined(WITCHENGINE_NO_RAYTRACING_SHADER) && (defined(WITCHENGINE_NO_RAYTRACING_RENDERER))
#	define WITCHENGINE_NO_RAYTRACING_SHADER
#endif

// Destruction
#if !defined(WITCHENGINE_NO_DESTRUCTION) && (defined(WITCHENGINE_NO_PHYSIC))
#	define WITCHENGINE_NO_DESCTRUCTION
#endif

// Real-time destruction
#if !defined(WITCHENGINE_NO_REALTIME_DESTRUCTION) && (defined(WITCHENGINE_NO_PHYSIC) || defined(WITCHENGINE_NO_DESTRUCTION) || (defined(WITCHENGINE_NO_CUDA_SUPPORT) && defined(WITCHENGINE_NO_OPENCL_SUPPORT)))
#	define WITCHENGINE_NO_REALTIME_DESTRUCTION
#endif
